...
<h1 class="text-center">Page เเก้ไขข้อมูล</h1>
<form action="{{route('users.update')}}" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="fullname" name="fullname" value="{{$users->username}}">
    ...
    <div class="form-group">
        ...
        <select name="role" id="role" class="form-control">
            ...
            <option value="2"{{$users->role == 1 ? 'selected':''}}>User</option>
        </select>
